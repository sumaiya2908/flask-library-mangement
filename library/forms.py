...
class MemberForm(FlaskForm):
    ...
    def validate_member_name(self, member_name_to_check): #check if unique memberName already exists
    ...
    def validate_phone_number(self, phone_number_to_check): #check if phone number already exists
